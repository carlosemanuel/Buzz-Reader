...
import br.com.carlosemanuel.buzzreader.parsers.handlers.UserProfilesHandler;
...
public class BuzzUsersProfilesParser {
	...
	public static List<BuzzUserProfile> parseUsersProfiles(InputStream in)
		...
		List<BuzzUserProfile> profiles = null;
		try {
			JSONObject root = new JSONObject(builder.toString());
			JSONObject data = root.getJSONObject("data");
			profiles = UserProfilesHandler.handle(data);
		} catch (Exception e) {
