...
import br.com.carlosemanuel.buzzreader.parsers.handlers.UserProfileHandler;
...
public class BuzzUserProfileParser {
	...
	public static BuzzUserProfile parseProfile(InputStream in)
		...
		BuzzUserProfile feed = null;
		try {
			JSONObject root = new JSONObject(builder.toString());
			JSONObject data = root.getJSONObject("data");
			feed = UserProfileHandler.handle(data);
		} catch (Exception e) {
